...
open class RunnerPageble(
    ...
    override fun run(vararg args: String?) {
        val withPage = Pageable.ofSize(1000).withPage(0)
//        identity_11933
        val fi = clientRepository.fi(true, false, "nameCKse2i3hVubBSbAvokhA", withPage)


        val findAll = clientRepository.findAll(withPage)
        val totalPages = findAll.totalPages
        val totalElements = findAll.totalElements
        println(1)
//        val inputStream =
